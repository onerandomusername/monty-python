...
class Emojis(commands.Cog):
    ...
    def embed_builder(emoji: dict) -> Tuple[Embed, List[str]]:
        ...
        embed = Embed(color=Colours.orange, title="Emoji Count", timestamp=datetime.utcnow())
        msg = []
